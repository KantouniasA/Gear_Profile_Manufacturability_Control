...
% [~,~,ro1] = Involute_Contact_New(z1,module);
% [~,~,ro2] = Involute_Contact(z2,module);
[xc1,yc1, ro1 ,ro2] = Involute_Contact_new(z1,z2,module);
...
Ry = ro1;
xerror = asin(tg/Ry);
planes = 5; %arithmos epipesdon
xerrors = linspace(0,xerror,planes);
yerrors = linspace(0,yerror,planes);
tgears = linspace(0,tgear,planes);
for n = 1:planes
[x1_cent,y1_cent,x2_cent,y2_cent,x1_imag,y1_imag,x2_imag,y2_imag,dthick2] = ypokopi_calc_V3(xcc,ycc,ro1,ro2,xerrors(n),yerrors(n),Ry);
