function [x1_cent,y1_cent,x2_cent,y2_cent,x1_imag,y1_imag,x2_imag,y2_imag,dthick2] = ypokopi_calc_V3(xe,ye,ro1,ro2,xerror,yerror,Ry)
...
function[x1_imag,y1_imag,x2_imag,y2_imag,dthick2] = find_th_eq(x_imag,y_imag,x_real,y_real,dth,xerror,yerror,ro1,ro2,thickness,Ry)
