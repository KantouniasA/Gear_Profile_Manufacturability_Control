function [x1_cent,y1_cent,x2_cent,y2_cent,x1_imag,y1_imag,x2_imag,y2_imag,dthick2] = ypokopi_calc_V3(xe,ye,ro1,ro2,xerror,yerror,Ry,Rx)
...
[x_1imag_n,y_1imag_n,x_2imag_n,y_2imag_n,dthick2_n] = find_th_eq(x_imag,y_imag,x1_cent(n),y1_cent(n),th_cent(n),xerror,yerror,ro1,ro2,thickness,Ry,Rx);
x1_imag(n) = x_1imag_n;
y1_imag(n) = y_1imag_n;
x2_imag(n) = x_2imag_n;
y2_imag(n) = y_2imag_n;
...
function[x1_imag,y1_imag,x2_imag,y2_imag,dthick2] = find_th_eq(x_imag,y_imag,x_real,y_real,dth,xerror,yerror,ro1,ro2,thickness,Ry,Rx)
...
dx = 1*(1-cos(yerror))*(Rx-x_real+0*Dx);
