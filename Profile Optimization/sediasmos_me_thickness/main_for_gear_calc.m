...
for n = 1:planes
[x1_cent,y1_cent,x2_cent,y2_cent,x1_imag,y1_imag,x2_imag,y2_imag] = ypokopi_calc_V2(xcc,ycc,ro1,ro2,xerrors(end),yerrors(end),tgears(n));
tt = tgears(n)*ones(1,length(x1_imag))/2;
xyimag1 = [x1_imag',y1_imag'+ro1,tt'];
xyimag1 = [xyimag1(1,:);xyimag1(5:end,:)];
xyimag2 = [x2_imag',y2_imag'+ro1,tt'];
xyimag2 = [xyimag2(1,:);xyimag2(5:end,:)];
